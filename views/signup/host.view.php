  ...
  <header class="section-padding">
    ...
    <section>
      <form action="/culture_swap/signup/host" method="POST">
        ...
        <textarea id="about_family" name="about-family" placeholder="for example: your experance "
          rows="10" required></textarea><br>

        <label for="help_with">What Are You Looking for Help With?</label><br>
        <input type="checkbox" id="help_none" name="help-with[]" value="none" checked>
        <label for="help_none">Farmstay help</label><br>
        <input type="checkbox" id="help_one" name="help-with[]" value="one">
        <label for="help_one">Creating/ Cooking family meals</label><br>
        <input type="checkbox" id="help_two" name="help-with[]" value="two" required>
        <label for="help_two">Art Projects</label><br>
        <input type="checkbox" id="help_three" name="help-with[]" value="three">
        <label for="help_three">Animal Care</label><br>
        <input type="checkbox" id="help_four" name="help-with[]" value="four">
        <label for="help_four">Teaching </label><br>
        <input type="checkbox" id="help_five" name="help-with[]" value="five">
        <label for="help_five">Language practice</label><br>

        <label for="more_info">Some More Information:</label><br>
        <input type="checkbox" id="info_none" name="more-info[]" value="none" checked>
        <label for="info_none">Do you have Internet access? </label><br>
        <input type="checkbox" id="info_one" name="more-info[]" value="one">
        <label for="info_one">Is your internet access limited? </label><br>
        <input type="checkbox" id="info_two" name="more-info[]" value="two">
        <label for="info_two">Do you have animals/pets</label><br>
        <input type="checkbox" id="info_three" name="more-info[]" value="three" required>
